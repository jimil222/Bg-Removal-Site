...
const BgSlider = () => {
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
      ...
      <input className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full z-10 slider' type="range" name="" id="" min={0} max={100} value={sliderposition} onChange={handleSliderChange}/>
      </div>
    </div>
  )
}
